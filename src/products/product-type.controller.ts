...
export class ProductTypeController {
  ...
  updateBatch(@Body() dtoList: ProductTypeDto[]): Promise<PfxHttpResponseDto> {
  ...
  @Patch('/update')
  @HttpCode(HttpStatus.OK)
  update(@Body() dto: ProductTypeDto): Promise<PfxHttpResponseDto> {
  ...
  synchronize(
    ...
    return this.productTypeService.synchronize(companyId, paginationDto)
    .then( (msg: string) => {
      const response = new PfxHttpResponseDto(HttpStatus.OK, msg);
      const end = performance.now();
